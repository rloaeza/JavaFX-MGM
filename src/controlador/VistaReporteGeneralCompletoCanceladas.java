...
public class VistaReporteGeneralCompletoCanceladas extends Controlador implements Initializable {
        ...
        TablaReporte.setOnMouseClicked(new EventHandler<>() {
            ...
            public void handle(MouseEvent event) {
                ...
                try {
                    ...
                    paramsVista.put("vista", "/vista/venta_editar_unica_cancelada.fxml");
