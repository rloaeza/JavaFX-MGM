...
public class VistaReporteGeneralTipoPago extends Controlador implements Initializable {
    ...
    @FXML
    void seleccionarEfectivo(ActionEvent event) {
        RadioTarjeta.setSelected(false);

    }

    @FXML
    void seleccionarTarjeta(ActionEvent event) {
    ...
    void generarReporte(ActionEvent event) throws IOException {
        ...
        paramsJSONReporte.put("tipoPago", RadioEfectivo.isSelected()?1:2);
        //System.out.println("tipo de pago = "+ (RadioEfectivo.isSelected()?1:2) );
