...
public class PersonalHorarios {
    ...
    public PersonalHorarios() {
    }

    public PersonalHorarios(int idPersonal, String nombre, String apellidos, String email, String telefono, String movil, String usuario, String clave, String huella0, String huella1, String huella2, String huella3, String huella4, int idClinica, int tipo) {
